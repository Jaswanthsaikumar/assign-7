...
public class Eventorganisation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
     SimpleDateFormat fmt=new SimpleDateFormat("dd/MM/yyyy");
		Date d1=fmt.parse("16/01/2021");
		Date d2=fmt.parse("18/02/2021");
		Date d3=fmt.parse("19/03/2021");
		
		Event e1=new Event("rangoli", "delhi", d1, 17, 20);
		Event e2=new Event("Dancing", "Chennai", d2, 4, 10);
		Event e3=new Event("singing", "banglore", d3, 13, 15);
